...
public class FoodServiceImpl implements FoodService {
     ...
     */
    public Food save(Food food) throws AnimalManagementException {
     ...
     */
    public Food findById(int id)  throws AnimalManagementException {
     ...
     */
    public List<Food> findByName(String name) throws AnimalManagementException {
    	List<Food> foods = foodDao.findByName(name);
    	if(foods.isEmpty()) {
    		return null;
    	} else {
    		return foods;
    ...
    public List<Food> findAll() throws AnimalManagementException{
    	return foodDao.findAll();	
    }
    
    public void updateFood(Food food, int id)  throws AnimalManagementException{
        try {
        	Food oldFood = foodDao.findById(id);
        	if(null==oldFood) {
        		throw new AnimalManagementException("Food Not found");
        	} else {
        		oldFood.setIsDeleted(food.getIsDeleted());
        	...
        	throw new AnimalManagementException(exception.getMessage()
        			+"Error found while updating food");
        }
    }   
}
